...
description: How @mongez/vite generates and writes an Apache .htaccess file into the build output for SPA routing, HTTPS enforcement, compression, and cache headers.
when_to_use: User is deploying a Vite SPA to Apache, user wants to generate a .htaccess with mongezVite(), user is configuring the htaccess option, user wants to understand what the bundled .htaccess template contains or how to customise it.
---
